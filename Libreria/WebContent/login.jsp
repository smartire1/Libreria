...
<body class="page-body">
  ...
  <div class="image-bg inset-border" style="position: relative; border-top: 2px inset">
    <div id="loginBox" class="bg-white mx-auto" style="border: 1px solid; padding: 10px; border-radius: 5px; height: 280px; width: 300px; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
      <div class="container">
        <p class="lead text-center" style="font-weight: bold;">Login</p>
          ...
          <div class="container">
            <div class="row text-center">
              ...
              <div class="col-sm">
                <br>
                <br>
                <p class="lead" style="font-size: 100%;">Non sei registrato? <a href="signin.jsp" target="_self">Registrati</a></p>
